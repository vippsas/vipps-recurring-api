...
- [ ] Integrate _all_ the [API endpoints](vipps-recurring-api.md) described in our guide:
    ...
    - For examples of requests and responses, see the [Postman collection](./tools/vipps-recurring-api-quick-start-collection.json) and [environment](./tools/vipps-recurring-api-quick-start-environment.json).
