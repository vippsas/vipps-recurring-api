...
4. If there is a product that is shipped to the customer, the initial charge should be captured at this point.
   Capture the charge:
   [`POST:/recurring/v3/agreements/{agreementId}/charges/{chargeId}/capture`][capture-charge-endpoint]
...
| [Update an agreement](#update-an-agreement)   |  Update an agreement with new details. |  [`PATCH:/recurring/v2/agreements/{agreementId}`][update-agreement-endpoint] |
| [Stop an agreement](#stop-an-agreement) | Update the status to `STOPPED`.  | [`PATCH:/recurring/v2/agreements/{agreementId}`][update-agreement-endpoint]  |
...
[`PATCH:/recurring/v2/agreements/{agreementId}`][update-agreement-endpoint]
...
[`GET:/recurring/v3/agreements/{agreementId}/charges/{chargeId}`][fetch-charge-endpoint].
...
[`GET:/recurring/v3/agreements/{agreementId}/charges`][list-charges-endpoint].
...
| 3 | `STOPPED`  | Agreement has been stopped, either by the merchant by [`PATCH:/recurring/v2/agreements/{agreementId}`][update-agreement-endpoint], or by the user by cancelling or rejecting the agreement. |
...
[list-charges-endpoint]: https://vippsas.github.io/vipps-recurring-api/#/Charge%20v3%20endpoints/ListChargesV3
[create-charge-endpoint]: https://vippsas.github.io/vipps-recurring-api/#/Charge%20v3%20endpoints/CreateChargeV3
[fetch-charge-endpoint]: https://vippsas.github.io/vipps-recurring-api/#/Charge%20v3%20endpoints/FetchChargeV3
[capture-charge-endpoint]: https://vippsas.github.io/vipps-recurring-api/#/Charge%20v3%20endpoints/CaptureChargeV3
[cancel-charge-endpoint]: https://vippsas.github.io/vipps-recurring-api/#/Charge%20v3%20endpoints/CancelChargeV3
[refund-charge-endpoint]: https://vippsas.github.io/vipps-recurring-api/#/Charge%20v3%20endpoints/RefundChargeV3
