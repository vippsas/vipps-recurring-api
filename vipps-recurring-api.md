...
| [Update an agreement](#update-an-agreement)   |  Update an agreement with new details. |  [`PATCH:/recurring/v3/agreements/{agreementId}`][update-agreement-endpoint] |
...
There is 4 different campaign types: price campaign, period campaign, event campaign, and full flex campaign. See more about the different campaign types in the table below.
...
Once the user completes the session a unique identifier `sub` can be retrieved in the agreement details [`GET:/recurring/v3/agreements/{agreementId}`][fetch-agreement-endpoint] endpoint alongside the full URL to Userinfo.
...
[`POST:/recurring/v3/agreements/{agreementId}/accept`][force-accept-agreement-endpoint].
