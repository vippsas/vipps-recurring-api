...
* Use a `FULL_FLEX_CAMPAIGN` to display to the new customers that they will get a better price if they stay subscribed. See [full flex campaign](../recurring-api-guide.md#full-flex-campaign) for more details.
